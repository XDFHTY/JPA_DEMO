...
public class IKUtil {
    ...
    //敏感词过滤
    public void zh_cnFiter() throws IOException{
        ...
        //初始化敏感词库
        IKUtil.init(sensitiveWordSet);

        /**
         * 需要进行处理的目标字符串
         */
        System.out.println("敏感词的数量：" + IKUtil.sensitiveWordMap.size());
         ...
         */
        try {
            boolean result = IKUtil.contains(string);
         ...
         * 获取语句中的敏感词
         */
        Set<String> set = IKUtil.getSensitiveWord(string);
        System.out.println("语句中包含敏感词的个数为：" + set.size() + "。包含：" + set);

        /**
         * 替换语句中的敏感词
         */
        String filterStr = IKUtil.replaceSensitiveWord(string, '*');
        System.out.println(filterStr);

        String filterStr2 = IKUtil.replaceSensitiveWord(string, "[*敏感词*]");
    ...
    //IK中文分词
    public void zh_cnPPL(String[] strings){
